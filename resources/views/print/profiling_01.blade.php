            ...
            <td colspan="2" style="border-top-style: none;border-bottom-style: none">
                ...
                <table style="width: 400px;border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td style="width: 150px;">{{ $tax->profiling01->total_mark }}</td>
                    </tr>
                    <tr>
                        <td><strong>2. % tahap risiko (Jumlah markah/100) x 100%</strong></td>
                        <td>{{ $tax->profiling01->risk_level }}</td>
                    </tr>
                    </tbody>
                </table>
            </td>
        ...
        <tr>
            <td colspan="2" style="border-top-style: none;font-size: 30px;text-align:center;font-weight: bold">
                @if ($tax->profiling01->risk_level_text == 'TINGGI')
                    <span style="color: red">RISIKO {{ $tax->profiling01->risk_level_text }}</span>
                @elseif ($tax->profiling01->risk_level_text == 'SEDERHANA')
                    <span style="color: yellow">RISIKO {{ $tax->profiling01->risk_level_text }}</span>
                @elseif ($tax->profiling01->risk_level_text == 'RENDAH')
                    <span style="color: green">RISIKO {{ $tax->profiling01->risk_level_text }}</span>
                @endif
            </td>
        </tr>
        </tbody>
