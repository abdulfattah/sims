            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div data-dx="textbox" data-name="business_name" data-mode="text" data-value="{!! \Request::old('business_name', isset($tax) ? $tax->business_name : NULL) !!}"
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div data-dx="textbox" data-name="trade_name" data-mode="text" data-value="{!! \Request::old('trade_name', isset($tax) ? $tax->trade_name : NULL) !!}"
                                data-readonly="true"></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>SST No</label>
                            <div data-dx="textbox" data-name="sst_no" data-mode="text" data-value="{!! \Request::old('sst_no', isset($tax) ? $tax->sst_no : NULL) !!}" data-readonly="true">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>GST No</label>
                            <div data-dx="textbox" data-name="gst_no" data-mode="text" data-value="{!! \Request::old('gst_no', isset($tax) ? $tax->gst_no : NULL) !!}" data-readonly="true">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div data-dx="textbox" data-name="station_code" data-mode="text" data-value="{!! \Request::old('station_code', isset($tax) ? $tax->station_code : NULL) !!}"
                                data-readonly="true"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div data-dx="textbox" data-name="station_name" data-mode="text" data-value="{!! \Request::old('station_name', isset($tax) ? $tax->station_name : NULL) !!}"
                                data-readonly="true"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Email</label>
                            <div data-dx="textbox" data-name="email_address" data-mode="text" data-value="{!! \Request::old('email_address', isset($tax) ? $tax->email_address : NULL) !!}"
                                data-readonly="true"></div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <div data-dx="textbox" data-name="telephone_no" data-mode="text" data-value="{!! \Request::old('telephone_no', isset($tax) ? $tax->telephone_no : NULL) !!}"
                                data-readonly="true"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div data-dx="textbox" data-name="business_name" data-mode="text" data-value="{!! \Request::old('company_address_1', isset($tax) ? $tax->company_address_1 : NULL) !!}"
                        data-readonly="true"></div>
                </div>
                <div class="form-group">
                    <label>Company Address (Line 1)</label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div data-dx="textbox" data-name="company_city" data-mode="text" data-value="{!! \Request::old('company_city', isset($tax) ? $tax->company_city : NULL) !!}"
                            data-readonly="true"></div>
                    </div>
                    <div class="form-group col-sm-4">
                        <label>Company State</label>
                        <div data-dx="textbox" data-name="company_state" data-mode="text" data-value="{!! \Request::old('company_state', isset($tax) ? $tax->company_state : NULL) !!}"
                            data-readonly="true"></div>
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div data-dx="textbox" data-name="factory_name" data-mode="text" data-value="{!! \Request::old('factory_name', isset($tax) ? $tax->factory_name : NULL) !!}"></div>
                        </div>
                    </div>
                    <div class="form-group row">
