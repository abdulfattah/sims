...
@else
    <div class="text-right">
        <a href="{{ URL::to('tax/' . $tax->id . '/edit?section=profiling&page=02') }}" class="btn btn-sm btn-primary mr-1" type="button">Update</a>
        <a href="{{ URL::to('print/profiling_02/' . $tax->id) }}" class="btn btn-sm btn-warning" type="button" target="_blank">Print</a>
    </div>
