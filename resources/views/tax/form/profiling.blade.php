<form method="POST" action="{!! \URL::to('profiling') !!}" id="form-profiling" class="form-horizontal" novalidate>
    @csrf
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input type="hidden" name="answer_01">
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q1i" type="radio" value="10" name="mark_01">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q1ii" type="radio" value="7" name="mark_01">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q1iii" type="radio" value="4" name="mark_01">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q1iv" type="radio" value="1" name="mark_01">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_02">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q2i" type="radio" value="5" name="mark_02">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q2ii" type="radio" value="2" name="mark_02">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_03">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q3i" type="radio" value="5" name="mark_03">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q3ii" type="radio" value="2" name="mark_03">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_04">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q4i" type="radio" value="10" name="mark_04">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q4ii" type="radio" value="5" name="mark_04">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_05">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q5i" type="radio" value="10" name="mark_05">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q5ii" type="radio" value="7" name="mark_05">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q5iii" type="radio" value="4" name="mark_05">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q5iv" type="radio" value="1" name="mark_05">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_06">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q6i" type="radio" value="10" name="mark_06">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q6ii" type="radio" value="7" name="mark_06">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q6iii" type="radio" value="4" name="mark_06">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q6iv" type="radio" value="1" name="mark_06">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_07">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q7i" type="radio" value="10" name="mark_07">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q7ii" type="radio" value="7" name="mark_07">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q7iii" type="radio" value="4" name="mark_07">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q7iv" type="radio" value="1" name="mark_07">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_08">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q8i" type="radio" value="5" name="mark_08">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q8ii" type="radio" value="2" name="mark_08">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_09">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q9i" type="radio" value="5" name="mark_09">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q9ii" type="radio" value="2" name="mark_09">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_10">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q10i" type="radio" value="10" name="mark_10">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q10ii" type="radio" value="7" name="mark_10">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q10iii" type="radio" value="4" name="mark_10">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q10iv" type="radio" value="1" name="mark_10">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_11">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q11i" type="radio" value="10" name="mark_11">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q11ii" type="radio" value="7" name="mark_11">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q11iii" type="radio" value="4" name="mark_11">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q11iv" type="radio" value="1" name="mark_11">
            ...
            <tr>
                <td colspan="3">
                    ...
                    <input type="hidden" name="answer_12">
                </td>
            </tr>
            <tr>
                <td class="text-center">i</td>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q12i" type="radio" value="10" name="mark_12">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q12ii" type="radio" value="7" name="mark_12">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q12iii" type="radio" value="4" name="mark_12">
            ...
            <tr>
                ...
                <td>
                    <div class="form-check">
                        <input class="form-check-input" id="q12iv" type="radio" value="1" name="mark_12">
                    ...
                    <table class="table-sm mt-3" style="border-style: hidden">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 150px;border-bottom-style: none"><input class="form-control" type="text" name="total_mark" readonly></td>
                            </tr>
                            <tr>
                                <td style="width: 550px;border-top-style: none"><strong>2. % tahap risiko (Jumlah markah/100) x 100%</strong></td>
                                <td style="width: 150px;border-top-style: none"></strong><input class="form-control" type="text" name="risk_level" readonly></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 70px;text-align: center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="TINGGI" name="risk_level_text" onclick="javascript: return false;">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 70px;text-align: center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="SEDERHANA" name="risk_level_text" onclick="javascript: return false;">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 70px;text-align: center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="RENDAH" name="risk_level_text" onclick="javascript: return false;">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
