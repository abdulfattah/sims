                ...
                <form method="POST" action="{{ URL::to('password/reset/' . $user->token) }}" id="form-reset" novalidate>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <div class="dx-texteditor-with-icon" data-dx="textbox" data-case="lowercase" data-name="username" data-mode="email" data-placeholder="Username"
                                     data-readonly="true"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <div class="dx-texteditor-with-icon" data-dx="textbox" data-name="password" data-mode="password" data-placeholder="New password" data-value=""
                                     data-validate="true"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <div class="dx-texteditor-with-icon" data-dx="textbox" data-name="retype_password" data-mode="password" data-placeholder="New password (retype)"
                                     data-value=""
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-right" style="margin-left: -5px;">
                            <div data-dx="btn-submit" data-type="default" data-text="Submit" data-disabled="true" data-validation-group="form" data-form="form-reset"></div>
                        </div>
                    </div>
                </form>
            </div>
